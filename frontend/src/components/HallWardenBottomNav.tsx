...
const navItems = [
  { href: '/hall-warden-dashboard', label: 'Home', icon: LayoutDashboard },
  { href: '/hall-warden-dashboard/residents', label: 'Residents', icon: Users },
  { href: '/hall-warden-dashboard/incidents', label: 'Incidents', icon: AlertTriangle, primary: true },
  { href: '/hall-warden-dashboard/settings', label: 'Settings', icon: Settings },
];

export default function HallWardenBottomNav() {
    ...
    >
      <div className="flex items-center justify-around h-16">
        {navItems.map((item) => {
          ...
          const isActive =
            item.href === '/hall-warden-dashboard'
              ? pathname === '/hall-warden-dashboard'
