...
const navItems = [
  { href: '/secretary-dashboard', label: 'Home', icon: LayoutDashboard },
  { href: '/secretary-dashboard/cases', label: 'Cases', icon: FolderOpen },
  { href: '/secretary-dashboard/reports', label: 'Reports', icon: FileText, primary: true },
  { href: '/secretary-dashboard/settings', label: 'Settings', icon: Settings },
];
