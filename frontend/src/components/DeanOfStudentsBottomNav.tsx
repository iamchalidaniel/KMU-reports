...
import { LayoutDashboard, FolderOpen, AlertTriangle, Settings } from 'lucide-react';

const navItems = [
  { href: '/dean-of-students-dashboard', label: 'Home', icon: LayoutDashboard },
  { href: '/dean-of-students-dashboard/cases', label: 'Cases', icon: FolderOpen },
  { href: '/dean-of-students-dashboard/incidents', label: 'Incidents', icon: AlertTriangle, primary: true },
  { href: '/dean-of-students-dashboard/settings', label: 'Settings', icon: Settings },
];

export default function DeanOfStudentsBottomNav() {
    ...
    >
      <div className="flex items-center justify-around h-16">
        {navItems.map((item) => {
          ...
          const isActive =
            item.href === '/dean-of-students-dashboard'
              ? pathname === '/dean-of-students-dashboard'
