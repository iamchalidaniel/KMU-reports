...
import { LayoutDashboard, FolderOpen, AlertTriangle, User } from 'lucide-react';

const navItems = [
  { href: '/student-dashboard', label: 'Home', icon: LayoutDashboard },
  { href: '/student-dashboard/records', label: 'Records', icon: FolderOpen },
  { href: '/student-dashboard/report-incident', label: 'Report', icon: AlertTriangle, primary: true },
