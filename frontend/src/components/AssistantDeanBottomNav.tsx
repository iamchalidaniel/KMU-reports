...
const navItems = [
  { href: '/assistant-dean-dashboard', label: 'Home', icon: LayoutDashboard },
  { href: '/assistant-dean-dashboard/cases', label: 'Cases', icon: FolderOpen },
  { href: '/assistant-dean-dashboard/incidents', label: 'Incidents', icon: AlertTriangle, primary: true },
  { href: '/assistant-dean-dashboard/settings', label: 'Settings', icon: Settings },
];

export default function AssistantDeanBottomNav() {
    ...
    >
      <div className="flex items-center justify-around h-16">
        {navItems.map((item) => {
          ...
          const isActive =
            item.href === '/assistant-dean-dashboard'
              ? pathname === '/assistant-dean-dashboard'
