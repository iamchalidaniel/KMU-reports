    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 text-gray-900 dark:text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-700/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 dark:border-gray-600 shadow-xl">
            <h2 className="text-2xl font-semibold mb-4 text-kmuGreen">About This Platform</h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              KMU Reports is a comprehensive digital platform designed to facilitate structured incident reporting and case management within Kapasa Makasa University. Our system supports both student conduct proceedings and facility maintenance workflows, ensuring secure, confidential submissions while maintaining transparency and accountability in all university administrative processes.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 bg-gradient-to-b from-gray-50/50 to-gray-100 dark:from-gray-800/50 dark:to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white dark:bg-gray-700/60 backdrop-blur-sm rounded-2xl p-8 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-600">
