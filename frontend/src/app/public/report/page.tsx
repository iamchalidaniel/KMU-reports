        ...
        <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
            <Link href="/home" className="flex items-center space-x-2">
              ...
              />
              <div>
                <div className="text-base font-bold text-gray-900 dark:text-white leading-tight">Campus<span className="text-kmuGreen">Care</span></div>
      ...
      <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link
              href="/home"
              className="px-4 py-1 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-bold transition-colors"
            >
              Back
            </Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['Low', 'Medium', 'High'].map(level => (
                    <label
                      key={level}
                      className={`relative flex items-center justify-center p-4 rounded-lg border-2 cursor-pointer transition-all ${formData.severity === level
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                <button
                  type="submit"
                  disabled={loading}
                  className={`flex-1 px-6 py-4 rounded-full font-bold text-lg transition-all duration-200 shadow-lg ${loading
                      ? 'bg-gray-400 text-white cursor-not-allowed'
                      : 'bg-kmuGreen text-white hover:bg-green-700 active:scale-95 shadow-green-500/20'
                    }`}
                >
                  {loading ? (
                ...
                <button
                  type="button"
                  onClick={() => router.back()}
                  className="px-10 py-4 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white rounded-full font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all active:scale-95"
                >
                  Cancel
                </button>
              </div>
